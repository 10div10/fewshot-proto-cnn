...
# Module-level File(...) defaults to avoid calling File() in function argument defaults (ruff B008)
CLASS_FILES_DEFAULT = File(...)
SINGLE_FILE_DEFAULT = File(...)
...
async def add_class(class_name: str, files: list[UploadFile] = CLASS_FILES_DEFAULT):
